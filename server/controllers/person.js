...
export const getPeople = async (req, res) => {
  ...
  try {
    const people = await Person.find({ user: id });
  ...
  try {
    ...
    if (person.relationship === "Partner") {
      const newEvent = new Event({
        ...
        picture:
          "https://images.ctfassets.net/iyiurthvosft/34CGIfinmuBbubQuEKmKRc/5aa2de9aaf6e1bbac3126d95a9cd96d1/iStock-860821478.jpg?fm=jpg&fl=progressive&q=50&w=1200",
      });
      const valentines = new Event({
        ...
        date: "14/02/2024",
        picture:
          "http://www.dynamitenews.com/images/2019/02/13/valentines-day-2019-celebrating-day-of-love-in-a-healthy-manner/36ad0ba.jpg",
      });
      await newEvent.save();
...
export const updatePerson = async (req, res) => {
  ...
  try {
    const updatedPerson = await Person.findByIdAndUpdate(id, personUpdates, {
      new: true,
    });
